...
const getAdvertencesList = () => {
  const endpoint = "https://lg-rolamentos-api.herokuapp.com/list-advertence/";
                  ...
                  <div className="acoes">
                    <Button className="acao consultar" outline>
                      <Link
                        className="linkForm"
                        to={
                          "/api/activities/advertences/formViewAdvertence/" +
                          tdata.id
                        }
                      >
                        Consultar
                    ...
                    <Button className="acao demitir" outline>
                      <Link
                        className="linkForm"
                        to={
                          "/api/activities/advertences/formDeleteAdvertence/" +
                          tdata.id
                        }
                      >
                        Excluir
